        ...
        <div class="write__contentsBox">
          ...
          <div class="write__textBox">
            ...
            <div name="emotions" class="write__emotions">
              <input value="기쁨" title="기쁨" type="radio" name="emotions" v-model="haru_diary.diary_emotions"><img src="../../images/writepage/emotions/happy.svg" alt="기쁨" width="25" height="25">
              <input value="슬픔" title="슬픔" type="radio" name="emotions" v-model="haru_diary.diary_emotions"><img src="../../images/writepage/emotions/sad.svg" alt="슬픔" width="25" height="25">
              <input value="보통" title="보통" type="radio" name="emotions" v-model="haru_diary.diary_emotions"><img src="../../images/writepage/emotions/normal.svg" alt="보통" width="25" height="25">
              <input value="짜증" title="짜증" type="radio" name="emotions" v-model="haru_diary.diary_emotions"><img src="../../images/writepage/emotions/rage.svg" alt="짜증" width="25" height="25">
              <input value="분노" title="분노" type="radio" name="emotions" v-model="haru_diary.diary_emotions"><img src="../../images/writepage/emotions/angry.svg" alt="분노" width="25" height="25">
            </div>
          ...
          <button type="button" name="button" class="wirte__button" @click="postHaru"></button>
        </div>
      </div>
