          ...
          <div class="signup__box">
            ...
            <div class="line__or">
              ...
              <fieldset class="signup__filedset">
                ...
                <input type="email" class="signup__input-email" id="user-id" placeholder="이메일" required>
                ...
                <input type="password" class="signup__input-password" id="user-pw" placeholder="비밀번호" minlength="8" required>
            ...
            <div class="user__box">
              ...
              <a href="#" class="user_login"><router-link to="/login">로그인</router-link></a>
            </div>
...
<style lang="sass">
  @import "../Sass_login_signup/haru.signup.2.sass"
</style>
